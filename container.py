...
class Container(tk.Frame):
    ...
    def widgets(self):
        ...
        btnventas = Button(frame1, bg="#f4b400", fg="white",
                           font=("sans", 18, "bold"), text="Ir a ventas", command=self.ventas)
        btnventas.place(x=500, y=30, width=240, height=60)

        btninventario = Button(frame1, bg="#c62e26", fg="white",
                               font=("sans", 18, "bold"), text="Ir a inventario", command=self.inventario)
        ...
        self.logo_label = tk.Label(
            frame1, image=self.logo_image, bg="#C6D9E3")
